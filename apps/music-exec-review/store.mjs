// Data layer for the music-exec review platform. JSON-file backed, no deps.
// All user submissions (executive profiles, reviews, responses) start as
// "pending" and only become publicly visible after moderator approval.
...
export function createStore(dataDir) {
  ...
  if (fs.existsSync(file)) {
    ...
    db = { executives: [], reviews: [], responses: [], disputes: [] };
